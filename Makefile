...
help:
	...
	@echo "  rollback TAG=<tag> - Roll back production to specific image version"
	...
	@echo "  5. make rollback    # Rollback to previous (if issues)"
...
ifdef TAG
	@echo "🎯 Rolling back to specific version: $(TAG)"
	@./scripts/rollback-image.sh rollback $(TAG)
else
